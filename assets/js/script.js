...
document.addEventListener('DOMContentLoaded', function () {
    ...
    let flip_button = document.querySelector('#flip')
    flip_button.addEventListener('click', function()  {
        ...
        if (flippedHeads) {
            ...
            document.getElementById('penny_img').src = 'assets/images/penny-heads.jpg'
            ...
            document.getElementById('penny_img').src = 'assets/images/penny-tails.jpg'
